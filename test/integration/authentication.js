      ...
      request.post(
        ...
        function(error, response, body) {
          ...
          assert(
            ...
            'status code not 302: ' + response.statusCode,
          );
      ...
      request.post(
        ...
        function(error, response, body) {
          ...
          assert(
            ...
            'expected 401, but response was actually ' + response.statusCode,
          );
      ...
      request.post(
        ...
        function(error, response, body) {
          User.findOne({
            ...
            user.isValidPassword('userpassword', function(
              error,
              passwordResponse,
            ) {
        ...
        function(error, response, body) {
          ...
          var loginRequest = http.request(
            ...
            function(response) {
              ...
              assert(
                response.statusCode === 302,
                'status code not 200/OK: ' + response.statusCode,
              );
              done();
            },
          );
          ...
          var loginRequest = http.request(
            ...
            function(response) {
              ...
              var sessioncookie =
                ...
                _.find(response.headers['set-cookie'], function(cookie) {
                  return cookie.match(/^connect.sid/) !== null;
                });

              assert(
                sessioncookie !== undefined,
                'session cookie not undefined: ' + sessioncookie,
              );
