...
function embedVine($selector) {
  ...
  $selector.filter(function(index, element) {
    ...
    $(element).replaceWith('<iframe src="https://www.vine.co/v/'  + matchID + '/embed/postcard"' +  ' width="600" height="600" frameborder="0"></iframe><script src="https://platform.vine.co/static/scripts/embed.js"></script>');
  });
}
