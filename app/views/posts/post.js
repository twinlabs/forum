...
var buf = [];
var locals_ = (locals || {}),post = locals_.post,moment = locals_.moment,marked = locals_.marked,user = locals_.user;buf.push("<div" + (jade.attrs({ 'data-id':(post.id), "class": [('atom')] }, {"data-id":true})) + "><div class=\"atom-meta meta clearfix\"><div class=\"atom-meta-main\"><div class=\"atom-meta-main-inner username datum\">" + (jade.escape(null == (jade.interp = post.user.name) ? "" : jade.interp)) + "</div><div class=\"atom-meta-extra\"><div class=\"atom-meta-extra-time time datum\"><i class=\"fa fa-clock-o\"></i><a" + (jade.attrs({ 'data-timestamp':(post.created_at.toString()), 'href':("?all=true#" + post.id), 'name':(post.id), "class": [('distance')] }, {"data-timestamp":true,"href":true,"name":true})) + ">" + (jade.escape(null == (jade.interp = moment(post.created_at).fromNow()) ? "" : jade.interp)) + "<span class=\"unread-icon\"><i class=\"fa fa-file-o\"></i></span></a></div></div></div></div><div class=\"content\">" + (null == (jade.interp = marked(post.body || '')) ? "" : jade.interp));
...
buf.push("<div class=\"atom-actions\"><a href=\"#quote\" class=\"atom-actions-action atom-actions-action--quote fa fa-quote-left fa-lg\"></a><div class=\"atom-actions-advanced\">");
if ( (post.user.id === user.id))
{
